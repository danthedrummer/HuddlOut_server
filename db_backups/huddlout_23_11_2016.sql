...
INSERT INTO `group_memberships` VALUES (2,8,3,'ADMIN'),(4,8,5,'ADMIN'),(5,1,3,'KICKED'),(8,14,8,'ADMIN'),(11,2,3,'INVITED');
...
INSERT INTO `groups` VALUES (3,'test_group','2016-11-17 16:58:22','2016-11-18 16:58:22',NULL),(5,'Team Hayes','2016-11-17 17:03:53','2016-11-18 17:03:53','Database Normalizati'),(8,'PW Group','2016-11-18 16:59:15','2016-11-19 16:59:15','Bowling');
...
INSERT INTO `user_profiles` VALUES (1,'John','Doe','ass.jpg',25,'...lol','PUBLIC'),(2,'John','Doe','ass.jpg',25,'...lol','PUBLIC'),(3,'John','Doe','ass.jpg',25,'...lol','PUBLIC'),(4,'John','Doe','ass.jpg',25,'...lol','PUBLIC'),(5,'John','Doe','ass.jpg',25,'...lol','PUBLIC'),(6,'John','Doe','ass.jpg',25,'...lol','PUBLIC'),(7,'John','Doe','ass.jpg',25,'...lol','PUBLIC'),(8,'Aaron','Meaney','1',25,'I like turtles','PUBLIC'),(9,'John','Doe','ass.jpg',25,'...lol','PUBLIC'),(12,'testUser10',NULL,NULL,NULL,NULL,'PUBLIC'),(13,'testUser11',NULL,'hello.png',NULL,NULL,'PUBLIC'),(14,'pwisthis',NULL,NULL,NULL,NULL,'PUBLIC');
...
CREATE TABLE `user_relationships` (
  ...
  `relationship_type` enum('Friend','Best Friend','Blocked') NOT NULL,
  PRIMARY KEY (`relationship_id`),
  KEY `profile_a` (`profile_a`),
  KEY `profile_b` (`profile_b`),
  CONSTRAINT `user_relationships_ibfk_1` FOREIGN KEY (`profile_a`) REFERENCES `user_profiles` (`profile_id`),
  CONSTRAINT `user_relationships_ibfk_2` FOREIGN KEY (`profile_b`) REFERENCES `user_profiles` (`profile_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-11-23 15:05:30
